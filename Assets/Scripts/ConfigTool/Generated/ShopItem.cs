...
namespace ConfigData
{
    ...
    /// </summary>
    [Serializable]
    public class ShopItem : ConfigDataBase
    {
        /// <summary>
        /// 名字
        /// </summary>
        ...
        {
            return $"ShopItem[ID={ID}, name={name}, desc={desc}]";
        }
    }
    ...
    public static class ShopItemManager
    {
        ...
        /// 所有配置数据的静态字典
        /// </summary>
        private static readonly Dictionary<int, ShopItem> _configs = new Dictionary<int, ShopItem>
        {
            { 10001, new ShopItem
            {
                idValue = 10001,
        ...
        public static ShopItem GetConfig<T>(T id)
        {
            // 尝试将泛型类型转换为字典键类型
        ...
        /// 根据int类型ID获取配置数据
        /// </summary>
        public static ShopItem GetConfig(int id)
        {
        ...
        /// </summary>
        public static ShopItem GetConfig(string id)
        {
        ...
        public static Dictionary<int, ShopItem> GetAllConfigs()
        {
            return new Dictionary<int, ShopItem>(_configs);
        }
