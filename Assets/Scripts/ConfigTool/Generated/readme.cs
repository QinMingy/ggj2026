...
namespace ConfigData
{
    ...
    /// </summary>
    [Serializable]
    public class readme : ConfigDataBase
    {
        /// <summary>
        /// misc
        /// </summary>
    ...
    public static class readmeManager
    {
        ...
        /// 所有配置数据的静态字典
        /// </summary>
        private static readonly Dictionary<int, readme> _configs = new Dictionary<int, readme>
        {
        };
        ...
        public static readme GetConfig<T>(T id)
        {
            // 尝试将泛型类型转换为字典键类型
        ...
        /// 根据int类型ID获取配置数据
        /// </summary>
        public static readme GetConfig(int id)
        {
        ...
        /// </summary>
        public static readme GetConfig(string id)
        {
        ...
        public static Dictionary<int, readme> GetAllConfigs()
        {
            return new Dictionary<int, readme>(_configs);
        }
